...
porcentaje_bajo = 0.01  # Porcentaje por debajo del precio actual (1%)
...
def monitorear_precio(par, intervalo, porcentaje_bajo):
    precio_anterior = obtener_precio(par)
    precio_objetivo = precio_anterior * (1 - porcentaje_bajo)  # Calcular el precio objetivo
    ...
    while True:
        ...
        if precio_actual > precio_anterior:
            ...
            precio_objetivo = precio_anterior * (1 - porcentaje_bajo)  # Recalcular el precio objetivo
        ...
        if precio_actual <= precio_objetivo:
            print(f'¡Vende! El precio ha bajado a {precio_actual}, que es igual o menor que el precio objetivo de {precio_objetivo}.')
            break  # Salir del bucle si se debe cerrar

        time.sleep(intervalo)  # Esperar el intervalo especificado

# Llamar a la función
monitorear_precio(par, intervalo, porcentaje_bajo)  